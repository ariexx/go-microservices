...
const (
	PaymentService_GetPayments_FullMethodName = "/pb.PaymentService/GetPayments"
	PaymentService_GetPayment_FullMethodName  = "/pb.PaymentService/GetPayment"
)
...
type PaymentServiceClient interface {
	GetPayments(ctx context.Context, in *GetAllEmpty, opts ...grpc.CallOption) (*GetAllPaymentResponse, error)
...
func (c *paymentServiceClient) GetPayments(ctx context.Context, in *GetAllEmpty, opts ...grpc.CallOption) (*GetAllPaymentResponse, error) {
	out := new(GetAllPaymentResponse)
	err := c.cc.Invoke(ctx, PaymentService_GetPayments_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PaymentServiceServer interface {
	GetPayments(context.Context, *GetAllEmpty) (*GetAllPaymentResponse, error)
...
func (UnimplementedPaymentServiceServer) GetPayments(context.Context, *GetAllEmpty) (*GetAllPaymentResponse, error) {
...
func _PaymentService_GetPayments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetPayments(ctx, req.(*GetAllEmpty))
	}
